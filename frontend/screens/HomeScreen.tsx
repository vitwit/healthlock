...
import InfoCarousel from './InfoCarousel'; // Import the carousel component
...
const HomeScreen = () => {
  ...
  return (
    <LinearGradient
      ...
      {/* Show carousel for regular users or registered organizations */}
      {(selectedRole === 'user' ||
        (selectedRole === 'organization' && registeredOrganization)) && (
        <View style={styles.carouselContainer}>
          <InfoCarousel />
        </View>
      )}

      {/* Show registration form for unregistered organizations */}
      {!(
        selectedRole === 'user' ||
        (selectedRole === 'organization' && registeredOrganization)
      ) && (
            ...
            !registeredOrganization && (
              <View style={styles.registrationForm}>
                <Text style={styles.formHeading}>
                  Your organization is not registered. Please create an account
                ...
                <TouchableOpacity
                  style={[
                    ...
                    registerOrganizationLoading && styles.disabledButton,
                  ]}
                  onPress={onClickRegisterOrg}
                  disabled={registerOrganizationLoading}>
                  <Text style={styles.registerButtonText}>
                    {registerOrganizationLoading
                      ? 'Registering...'
                      : 'Register'}
                  </Text>
                </TouchableOpacity>
